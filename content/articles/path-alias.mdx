...
tags:
  ...
  - note
description: |
  Относительные пути в импортах — это зло.
  В данной статье рассмотрим конфигурации для Vite, ESBuild, Rollup и Webpack
  для того чтобы избежать проблемы относительных импортов
date: 2023-04-01
---
