...
description: |
  ...
  С помощью данной библиотеки мы будем динамически генерировать Open Graph превью для страниц.
date: 2023-04-08
---
...
> - `prod`: `https://developer-log.vercel.app/fonts/manrope/Manrope-Regular.ttf`.
